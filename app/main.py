...
# Criando app FastAPI
#pp = FastAPI(title="API Prontuário Psicológico")
...
# Incluindo routers com prefixo /api/v1
app.include_router(paciente_routes, prefix="/api/v1")
app.include_router(prontuario_routes, prefix="/api/v1")
app.include_router(documento_routes, prefix="/api/v1")
app.include_router(usuario_routes, prefix="/api/v1")
app.include_router(sessoes_routes, prefix="/api/v1")
app.include_router(evolucao_routes, prefix="/api/v1")
